...
DR.LAND_PATH = [
  { name: '陇西驿道', type: 'way' },
  { name: '河西走廊', type: 'way' },
  { name: '敦煌·莫高窟', type: 'site', offers: ['prajna', 'kshanti', 'dana'], crossover: true },
  { name: '高昌', type: 'story', story: {
      title: '高昌王的情谊',
      text: '高昌国王麹文泰十分敬重你,与你结为兄弟,赠予丰厚盘缠,还派士兵护送一程。',
      effect: { merit: 5 },
    } },
  { name: '火焰山驿站', type: 'way' },
  { name: '龟兹', type: 'site', offers: ['prajna', 'virya', 'sila'] },
  { name: '姑墨驿站', type: 'way' },
  { name: '葱岭雪道', type: 'way' },
  { name: '迦湿弥罗', type: 'site', offers: ['dhyana', 'sila', 'kshanti'] },
  { name: '犍陀罗古道', type: 'way' },
  { name: '犍陀罗', type: 'site', offers: ['dana', 'virya', 'prajna'] },
  { name: '天竺边境', type: 'way' },
  { name: '王舍城外', type: 'way' },
  { name: '灵鹫山脚', type: 'way' },
  { name: '那烂陀寺', type: 'final', offers: ['dana', 'sila', 'kshanti', 'virya', 'dhyana', 'prajna'], story: {
      title: '灵鹫山下,豁然开朗',
...
DR.SEA_PATH = [
  { name: '广州港', type: 'way' },
  { name: '交趾', type: 'way', crossover: true },
  { name: '占婆', type: 'site', offers: ['dana', 'kshanti', 'virya'] },
  { name: '南海季风道', type: 'way' },
  { name: '室利佛逝', type: 'site', offers: ['prajna', 'dhyana', 'virya'] },
  { name: '马六甲海峡', type: 'way' },
  { name: '狮子国', type: 'site', offers: ['sila', 'kshanti', 'dhyana'] },
  { name: '南天竺外海', type: 'way' },
  { name: '南天竺登岸', type: 'story', story: {
      title: '有惊无险',
